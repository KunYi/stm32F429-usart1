...
Build instructions
==================
* prepare, you need download and build tools
```
    [STM32F429I-Discovery Firmware - STM32F429 Library](http://www.st.com/st-web-ui/static/active/en/st_prod_software_internet/resource/technical/software/firmware/stsw-stm32138.zip)
    [Stlink - Flash tools](https://github.com/texane/stlink)
    [GCC for ARM Embedded - Toolchain](https://launchpad.net/gcc-arm-embedded)
        currently on Linux(Ubuntu) use [gcc 4.8.2](https://launchpad.net/gcc-arm-embedded/4.8/4.8-2013-q4-major/+download/gcc-arm-none-eabi-4_8-2013q4-20131204-linux.tar.bz2)
```
...
```
    ...
    cd stm32f429
    #
    # Download [STM32F429I-Discovery Firmware](http://www.st.com/web/en/catalog/tools/PF259429)
    #
